...
Species allometric parameters and functional traits for Paracou and Tapajos used oth as input of TROLL evaluation and as output to assess forest functional composition. Numerous allometric parameters and functional traits didn't existed and have been inferred from dbh & height data or using relation among traits with predictive mean matching.

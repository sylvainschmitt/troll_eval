...
Inventory data from Paracou, including understory trees, and Tapajos used both as input of TROLL evaluation for the species list and as output to assess forest structure, neutral composition and species list.
...
Forest composition was simply be assessed using rank abundances curves cut at the number of species simulated in TROLL each plots (uncertainty dotted lines in Paracou data).

...
g <- daily %>% 
  filter(determinant == "par") %>% 
  ggplot(aes(determinant_value/10^2, value, col = type)) +
...
g <- daily %>% 
  ...
  ylim(0, NA) +
  ggpubr::stat_cor()
ggsave("figures/fs11.png", g, dpi = 300, width = 10, height = 6, bg = "white")
g
```
...
g <- daily %>% 
  ...
  ylim(0, NA) +
  ggpubr::stat_cor()
ggsave("figures/fs12.png", g, dpi = 300, width = 10, height = 6, bg = "white")
g
```

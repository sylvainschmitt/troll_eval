...
g <- daily %>% 
  ...
  ylim(0, 7.5) +
  ggpubr::stat_cor()
ggsave("figures/f03.png", g, dpi = 300, width = 10, height = 6, bg = "white")
g
```
...
g <- daily %>% 
  ...
  theme(legend.position = "bottom")
ggsave("figures/fs08.png", g, dpi = 300, width = 8, height = 5, bg = "white")
g
```
...
g <- daily %>% 
  ...
  ylim(0, 5.5) +
  ggpubr::stat_cor()
ggsave("figures/f04.png", g, dpi = 300, width = 10, height = 6, bg = "white")
g
```
